        ...
        return (
            <div id="modal1" className="modal" ref={modelRef}>
                ...
                <div className="modal-footer">
                    <button className="btn waves-effect waves-light #b71c1c red darken-4" type="submit" name="action">Cancel</button>
                    <button className="btn waves-effect waves-light #b71c1c red darken-4" type="submit" name="action">Yes</button>
                </div>
            </div>
        )
    }
    ...
    return (
        <>
            ...
            <div className="container center-align">
                ...
                <button className="btn waves-effect waves-light #b71c1c red darken-4" type="submit" name="action">Delete</button>
                {getModel()}
            </div>
        </>
    )
